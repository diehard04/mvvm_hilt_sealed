...
import com.example.hiltsealed.MainActivity;
...
import com.example.hiltsealed.viewmodel.PostsViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends BaseApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(PostsViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.postsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.example.hiltsealed.viewmodel.PostsViewModel", ((Provider) postsViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.hiltsealed.viewmodel.PostsViewModel 
          return (T) new PostsViewModel(singletonCImpl.postsRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends BaseApplication_HiltComponents.SingletonC {
    ...
    private Provider<ApiServices> providePostApiProvider;
    ...
    @SuppressWarnings("unchecked")
    private void initialize() {
      this.provideRetrofitProvider = DoubleCheck.provider(new SwitchingProvider<retrofit2.Retrofit.Builder>(singletonCImpl, 2));
      this.providePostApiProvider = DoubleCheck.provider(new SwitchingProvider<ApiServices>(singletonCImpl, 1));
      this.postsRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<PostsRepository>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.hiltsealed.repository.PostsRepository 
          return (T) new PostsRepository(singletonCImpl.providePostApiProvider.get());

          case 1: // com.example.hiltsealed.data.remote.ApiServices 
          return (T) RetrofitModule_ProvidePostApiFactory.providePostApi(singletonCImpl.provideRetrofitProvider.get());
